...
public class SimplePicture implements DigitalPicture {
     ...
     * 
     * @return String The extension (jpg, bmp, giff, etc)
     */
     ...
     * 
     * @return Graphics A graphics object to use for drawing
     */
     ...
     * 
     * @return Graphics2D The Graphics2D object for this picture
     */
     ...
     * 
     * @return String The file name associated with the picture
     */
     ...
     * 
     * @return PictureFrame The picture frame associated with this picture
     *                      (it may be null)
     */
     ...
     * 
     * @return Image The buffered image since it is an image
     */
     ...
     * @return int The pixel value as an integer (alpha, red, green, blue)
     */
    ...
    public void setBasicPixel( int x, int y, int rgb ) {
        ...
        //bufferedImage.getRaster().setSample(x, y, 0, rgb); //A different option
    }
     ...
     * @return Pixel A Pixel object for this location
     */
     ...
     * 
     * @return Pixel[] A one-dimensional array of Pixel objects starting with y=0
     ...
     * 
     * @return Pixel[][] A two-dimensional array of Pixel objects in row-major order.
     */
     ...
     * simple picture
     * 
     * @return JFrame Return the JFrame being used. This method was originally void,
     *                but a method in the Pixel class needed a reference to the JFrame,
     *                and there was no way around it
     */
    public JFrame explore() {
        // Create a copy of the current picture and explore it
        PictureExplorer explorer = new PictureExplorer(/*new SimplePicture(this)*/this);
        
        return explorer.getWindow();
    }
    ...
    public boolean load( String fileName ) {
        try {
            ...
            SOPln( "There was an error trying to open " + fileName );
     ...
     * @return Picture The resulting picture
     */
    ...
    public boolean write( String fileName ) {
        try {
            ...
            SOPln( "There was an error trying to write " + fileName );
            ex.printStackTrace();
            return false;
        }
    }
     ...
     * @return String The full path name by appending
     ...
     * @return Rectangle2D The enclosing rectangle
     */
     ...
     * 
     * @return String A string with information about the picture 
     */
    ...
    protected void SOPln(  String str ) { System.out.println( str );        }
    protected void SOPln()              { System.out.println();             }
    protected void SOP(    String str ) { System.out.print( str );          }
    protected void SOP()                { /*Nothing!*/                      }
    protected void nSOPln( String str ) { System.out.println( "\n" + str ); }
    protected void nSOP(   String str ) { System.out.print( "\n" + str );   }   
}